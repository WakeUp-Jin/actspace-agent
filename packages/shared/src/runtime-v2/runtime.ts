...
export type RuntimeV2AgentMode = "chat" | "plan" | "agent";
...
export type RuntimeV2SessionListItem = { readonly sessionId: string; readonly createdAt: string; readonly updatedAt: string; readonly workspaceRoot: string | null; readonly profileId: string; readonly accessState: RuntimeV2SessionSnapshot["accessState"]; readonly metadata: RuntimeV2SessionSnapshot["metadata"]; readonly lineage: RuntimeV2JsonValue | null };
export type RuntimeV2RunTurnRequest = { readonly sessionId: string; readonly content: RuntimeV2JsonValue; readonly messageId?: string; readonly agentRunId?: string; readonly model?: string; readonly mode?: RuntimeV2AgentMode; readonly keepPendingOnAbort?: boolean; readonly selectedSkillIds?: readonly string[] };
