...
contextBridge.exposeInMainWorld("actspace", {
  ...
  searchModelMetadata: (input: ModelMetadataSearchInput) => ipcRenderer.invoke("models:metadata:search", input) as Promise<ModelMetadataCatalogResult>,
  reloadModelMetadata: () => ipcRenderer.invoke("models:metadata:reload") as Promise<ModelMetadataCatalogResult>,
