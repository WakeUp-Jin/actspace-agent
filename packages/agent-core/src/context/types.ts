 ...
 *
 * 设计动机见 docs/design-docs/model-context/agent-token-usage-and-context-state.md 「DeepSeek Cache 设计影响」，
 ...
 * 消费。集中在一处便于统一调参，见
 * docs/design-docs/model-context/agent-context-compression.md 「配置与阈值」。
 */
