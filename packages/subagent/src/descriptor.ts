...
export const AGENT_SUBAGENT_DESCRIPTOR: SubagentDescriptor = Object.freeze({ id: "actspace.agent", version: 1, description: "Run a bounded general-purpose child Agent.", presetId: "actspace.agent" });
