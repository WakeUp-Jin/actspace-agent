...
- `bash-tool-reference-analysis.md`：Cursor / Claude Code / OpenCode 三家 Bash 工具实现的源码级调研对比；它是已归档 v1 Bash 设计的输入底稿，当前边界见 `docs/design-docs/execution-safety/README.md`。
