...
- 文档：`docs/design-docs/frontend/front-设置页规范.md` 外观章节定稿；执行计划 `docs/exec-plans/active/20260529-appearance-fonts-and-zoom.md`（A）与 `20260529-appearance-dark-theme.md`（B，深色专项）。
