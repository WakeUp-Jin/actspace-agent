...
- **更新设计文档状态**：`docs/archive/v1/design-docs/agent-kairos-autonomous-mode.md` 顶部状态从 Draft 改为"实施中"，增加 plan 完成清单。
...
- `docs/archive/v1/design-docs/agent-kairos-autonomous-mode.md`（状态徽章 + plan 完成清单）
