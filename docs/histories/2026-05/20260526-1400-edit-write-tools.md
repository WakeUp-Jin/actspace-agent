...
- `docs/design-docs/llm-agent-fix-plan/05-skill-file-tools-fix.md`：Skill 修复计划
...
- `docs/design-docs/agent-core/current-module-map.md`：记录新工具和 shared helper
- `docs/design-docs/agent-core/tool-preview-design-guidelines.md`：增加 write_file 展示规范
- `docs/design-docs/llm-agent-fix-plan/README.md`：索引新增修复文档
