...
- **[Design]**: 落 `docs/archive/v1/design-docs/front-Kairos监控页规范.md`，覆盖入口按钮位置、Sheet 行为、四段信息架构（概览 / 系统提示词 / 会话历史 / 工具列表）、`KairosContextSnapshot` 契约、新增 IPC、状态边界与测试策略；同步更新母规范与两份索引。
...
- `docs/archive/v1/design-docs/front-Kairos监控页规范.md`（新增）
