...
- `docs/archive/v1/design-docs/agent-kairos-autonomous-mode.md`：双维度说明 + v1→v2 迁移路径。
- `docs/archive/v1/design-docs/front-Kairos监控页规范.md`：用量胶囊章节重写，含切换按钮、双语义清零边界、tooltip 双 mode 对比、localStorage 持久化默认值。
