...
- v2 改版（用户确认后）：重命名为 `docs/archive/v1/design-docs/agent-plugins-fs-watch.md`，删除旧文件；`index.md`、`agent-index.md` 同步。
...
- `docs/archive/v1/design-docs/agent-plugins-fs-watch.md`（新增，替代已删除的 `agent-sidecar-fs-watch.md`）
