...
- 新增 `docs/design-docs/v1-legacy/agent-kairos-prompt-design.md`：Kairos 系统提示词分层设计（soul 插槽契约、预设人格、rule.md/briefs 分工与授权覆盖原则、机制段边界、设置页信息架构、被排除方案）。
...
- `docs/design-docs/v1-legacy/agent-kairos-prompt-design.md`
