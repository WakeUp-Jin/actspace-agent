...
> Generator 1.0.0; source digest `d81adad125e94cab987b2e23c24fb2b6ef4c8bc76a904ea3b4e155b5f67600d9`.
...
- Services: 14
- Events: 73 (Session core 13, Loop interventions 10, notifications 6)
- Plugins: 19
- Packages: 32
...
| permission/asked | extension | session | active | session |  | present | none |  | @actspace/session-journal | packages/session/journal/src/core-codecs.ts#PERSISTED_EXTENSION_EVENT_TYPES | session-journal/core-codec-contract<br>cordis-adapter/event-contract |
| permission/decided | extension | session | active | session |  | present | none |  | @actspace/session-journal | packages/session/journal/src/core-codecs.ts#PERSISTED_EXTENSION_EVENT_TYPES | session-journal/core-codec-contract<br>cordis-adapter/event-contract |
| permission/grant-added | extension | session | active | session |  | present | none |  | @actspace/session-journal | packages/session/journal/src/core-codecs.ts#PERSISTED_EXTENSION_EVENT_TYPES | session-journal/core-codec-contract<br>cordis-adapter/event-contract |
| permission/grant-revoked | extension | session | active | session |  | present | none |  | @actspace/session-journal | packages/session/journal/src/core-codecs.ts#PERSISTED_EXTENSION_EVENT_TYPES | session-journal/core-codec-contract<br>cordis-adapter/event-contract |
| permission/mode-set | extension | session | active | session |  | present | none |  | @actspace/session-journal | packages/session/journal/src/core-codecs.ts#PERSISTED_EXTENSION_EVENT_TYPES | session-journal/core-codec-contract<br>cordis-adapter/event-contract |
| permission/scope-denied | extension | session | active | session |  | present | none |  | @actspace/session-journal | packages/session/journal/src/core-codecs.ts#PERSISTED_EXTENSION_EVENT_TYPES | session-journal/core-codec-contract<br>cordis-adapter/event-contract |
...
| @actspace/client | domain | active | .<br>./sessions | @actspace/shared<br>pathe | packages/client/package.json#package.json | composition/admission-contract |
...
| @actspace/core-agent-loop | domain | active | .<br>./manifest<br>./plugin<br>./testing | @actspace/compaction<br>@actspace/context<br>@actspace/cordis-adapter<br>@actspace/core-agent<br>@actspace/core-scope<br>@actspace/llm-service<br>@actspace/prompt<br>@actspace/session-journal<br>@actspace/session-persistence<br>@actspace/shared<br>@actspace/tools-runtime | packages/core/agent-loop/package.json#package.json | composition/admission-contract |
...
| @actspace/tools-approval | domain | active | .<br>./manifest<br>./plugin | @actspace/cordis-adapter<br>@actspace/shared | packages/tools/approval/package.json#package.json | composition/admission-contract |
