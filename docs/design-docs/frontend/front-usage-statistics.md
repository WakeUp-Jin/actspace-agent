...
> **历史基线提示**：本文记录重构前的独立 Usage 仪表盘方案。当前 Usage 产品定位、信息架构和数据边界以 [`front-设置中心重构规范.md`](front-设置中心重构规范.md) 为准；本文保留用于迁移追溯。

> 2026-09-07 已实施的当前页面见[设置内使用统计页面更新](front-usage-statistics-refresh.md)；真实宿主验收边界见该任务摘要；其中的目录与费用方案不由本文的旧仪表盘口径推导。
