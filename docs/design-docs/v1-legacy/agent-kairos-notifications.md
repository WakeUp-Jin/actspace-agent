...
`docs/design-docs/v1-legacy/agent-kairos-autonomous-mode.md`（工具矩阵 / 事件流）、`docs/design-docs/v1-legacy/agent-kairos-prompt-design.md`
（授权覆盖原则、机制段边界）、`docs/design-docs/v1-legacy/front-Kairos监控页规范.md`（KairosPage 布局）。
