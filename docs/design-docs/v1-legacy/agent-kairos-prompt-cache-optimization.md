...
- `docs/design-docs/v1-legacy/agent-kairos-autonomous-mode.md`：Kairos 总体设计。
- `docs/design-docs/v1-legacy/model-context-agent-cache-loss-audit.md`：主会话缓存失效排查设计（断点分析方法论同源）。
