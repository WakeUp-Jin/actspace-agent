...
| 目录 | 内容边界 | 入口或代表文档 |
|---|---|---|
| `agent-runtime/` | Agent 主运行时、Run/Turn/LLM Call 分层、分析 Trace、当前模块和内部测试 | `docs/design-docs/agent-runtime/agent-backend-design.md` |
...
4. 涉及分析观测时读 `agent-runtime/agent-observability-trace-model.md`
