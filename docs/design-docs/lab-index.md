...
- `lab-experiment-lifecycle.md`：一轮实验从诞生、推进、暂停到毕业或废弃的完整生命周期。
- `lab-data-model.md`：Experiment、Stage、Artifact、Evidence、Review 等核心数据对象。
...
- `lab-promotion-and-safety.md`：长期能力晋升、权限、风险、沙箱和人工审批原则。
- `lab-versions-index.md`：版本拆分总览。
- `lab-v0-experiment-matrix.md`：V0 实验矩阵与手动记录。
- `lab-v1-assisted-experiment.md`：V1 Agent 辅助研究和实验记录。
- `lab-v2-sandbox-forge.md`：V2 沙箱验证与能力锻造。
- `lab-v3-autonomous-capability-rd.md`：V3 自主能力研发闭环。
