...
- `docs/archive/v1/design-docs/lab-product-design.md`：定义 Lab 的 North Star、产品定位、实验生命周期、核心数据模型、晋升评审和安全原则。
- `docs/archive/v1/design-docs/lab-runtime-architecture.md`：描述 Lab Runtime 与 Main Agent、Kairos、ToolManager、Skill / CLI / Tool Registry 的关系。
- `docs/archive/v1/design-docs/lab-versions-index.md`：拆分 V0-V3 的渐进式路线。

### 2. 前端原型

- `prototype.html`：已沉淀单文件交互原型，覆盖四栏实验矩阵、卡片详情弹窗、新实验弹窗和已完成实验弹窗。
- `docs/archive/v1/design-docs/lab-frontend-page-design.md`：已将原型转成前端页面规范，明确 V0 首页、阶段卡片、弹窗和不做项。
