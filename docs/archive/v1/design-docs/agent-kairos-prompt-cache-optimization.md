...
- `docs/archive/v1/design-docs/agent-kairos-autonomous-mode.md`：Kairos 总体设计。
- `docs/archive/v1/design-docs/model-context-agent-cache-loss-audit.md`：主会话缓存失效排查设计（断点分析方法论同源）。
- `docs/learnings/2026-06/event-replay-must-preserve-block-order.md`：事件重放保真原则的来源。
- `docs/archive/v1/code-design-audit/05-kairos-autonomous-mode.md`：压缩未接线的偏移记录。
