...
> 文档等级：v1-archive。以下是完整历史稿；其中“当前”“未来”与代码路径均指原写作语境。当前入口见 [v1 归档说明](../README.md)中的替代导航。
...
>
> 后续决策：本文中的 v1 事实继续有效；关于 Cordis、Agent Core、Session、LLM、Runtime、Kairos 和 fs-watch 的去留判断，已由 [v2 已确认决策](../../../design-docs/agent-plugin-runtime/agent-decisions-v2-foundation.md) 及相邻目标文档取代。
