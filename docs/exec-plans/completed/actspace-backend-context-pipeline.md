...
- `docs/design-docs/llm-agent-dev-skill-fix.md`（Skill 缺少 context modules 目录结构说明的补充）
...
Skill 的 `architecture.md` V0 目录结构展示了 `context/modules/` 子目录，但 context 参考文档（`mgmt-context-architecture.md`）未提及此结构。已记录到 `docs/design-docs/llm-agent-dev-skill-fix.md`。
...
- 2026-05-23：context 模块采用 modules/ 子目录结构，与 Skill architecture.md V0 目录保持一致。Skill context 参考文档缺少此目录结构说明，已记录到 `docs/design-docs/llm-agent-dev-skill-fix.md`。
