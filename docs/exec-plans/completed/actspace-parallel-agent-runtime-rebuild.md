...
本计划已被 `docs/archive/v1/design-docs/agent-runtime-backend-design.md` 拆分为更细的后端并行计划，不再作为 active 执行入口保留。
...
- `docs/design-docs/frontend/front-中间消息区规范.md`：理解后端事件如何对应消息组件。
