...
- `docs/archive/v1/design-docs/front-Kairos监控页规范.md`：本计划的视觉与交互事实来源；同时保留完整页面规范，避免 compact 需求反向削弱完整页。
- `docs/archive/v1/design-docs/agent-kairos-autonomous-mode.md`：Kairos 事件、工具和 IPC 契约事实来源。
