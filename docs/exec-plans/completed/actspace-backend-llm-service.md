...
- `docs/design-docs/llm-agent-dev-skill-fix.md`（Skill 缺少 services/ 目录建议的补充）
- `docs/SECURITY.md`
...
- 2026-05-23：采用 `llm/services/` 子目录分离基类和具体实现（Skill 原始设计中未覆盖此点，已记录到 `docs/design-docs/llm-agent-dev-skill-fix.md`）。
