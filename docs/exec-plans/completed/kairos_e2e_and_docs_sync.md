...
- 把 Kairos 的最终模块布局、IPC 契约、配置文件、事件流、调度规则、压缩策略 **完整反向同步**到 `docs/archive/v1/design-docs/agent-runtime-current-module-map.md`、`docs/design-docs/core-storage-and-observability.md`（如有）、`docs/QUALITY_SCORE.md` 与 `docs/exec-plans/README.md`。
...
- 包含：
  ...
  - `docs/archive/v1/design-docs/agent-runtime-current-module-map.md` 增补 Kairos 章节
...
- `AGENTS.md`
- `docs/archive/v1/design-docs/agent-kairos-autonomous-mode.md` 全文（最终对照标准）
