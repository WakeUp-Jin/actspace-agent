...
- 包含：
  ...
  - 复刻 `docs/design-docs/v1-legacy/prototype.html` 的四栏矩阵、顶部按钮、卡片详情弹窗、新实验弹窗、已完成实验弹窗和 `⋯` 菜单。
...
- 相关文档：
  ...
  - `docs/design-docs/v1-legacy/prototype.html`
  - `docs/design-docs/v1-legacy/lab-versions-index.md`
- 相关代码路径：
...
- 新建 `packages/desktop/src/renderer/fixtures/labFixture.ts`：
  ...
  - mock 内容对齐 `docs/design-docs/v1-legacy/prototype.html`，覆盖四个阶段和完成实验。
...
- 文档收尾：
  ...
  - 如实现与 `docs/design-docs/v1-legacy/lab-frontend-page-design.md` 不一致，同步设计文档。
...
- [x] 对齐 `docs/design-docs/v1-legacy/prototype.html` 和 `docs/design-docs/v1-legacy/lab-frontend-page-design.md` 的页面范围。
- [x] 完成 LabPage 外壳接入。
