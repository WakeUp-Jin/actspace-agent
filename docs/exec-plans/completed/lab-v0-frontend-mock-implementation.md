...
- 包含：
  ...
  - 复刻 `docs/archive/v1/design-docs/prototype.html` 的四栏矩阵、顶部按钮、卡片详情弹窗、新实验弹窗、已完成实验弹窗和 `⋯` 菜单。
...
- 相关文档：
  ...
  - `docs/archive/v1/design-docs/lab-README.md`
  - `docs/archive/v1/design-docs/lab-frontend-page-design.md`
  - `docs/archive/v1/design-docs/prototype.html`
  - `docs/archive/v1/design-docs/lab-versions-index.md`
- 相关代码路径：
...
- 新建 `packages/desktop/src/renderer/fixtures/labFixture.ts`：
  ...
  - mock 内容对齐 `docs/archive/v1/design-docs/prototype.html`，覆盖四个阶段和完成实验。
...
- 文档收尾：
  ...
  - 如实现与 `docs/archive/v1/design-docs/lab-frontend-page-design.md` 不一致，同步设计文档。
...
- [x] 对齐 `docs/archive/v1/design-docs/prototype.html` 和 `docs/archive/v1/design-docs/lab-frontend-page-design.md` 的页面范围。
- [x] 完成 LabPage 外壳接入。
