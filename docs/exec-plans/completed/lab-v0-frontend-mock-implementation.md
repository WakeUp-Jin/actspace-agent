...
- 文档收尾：
  ...
  - 如实现与 `docs/design-docs/lab/lab-frontend-page-design.md` 不一致，同步设计文档。
...
- [x] 对齐 `docs/design-docs/lab/prototype.html` 和 `docs/design-docs/lab/lab-frontend-page-design.md` 的页面范围。
- [x] 完成 LabPage 外壳接入。
