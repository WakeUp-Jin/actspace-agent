...
- 相关文档：
  ...
  - `docs/archive/v1/design-docs/lab-runtime-architecture.md`
  - `docs/archive/v1/design-docs/lab-product-design.md`
...
5. 文档与收尾
   - 更新 `docs/archive/v1/design-docs/agent-kairos-autonomous-mode.md`。
   - 更新 `docs/design-docs/core-storage-and-observability.md` 的 Kairos 目录树与存储边界，加入 `<userData>/kairos/inbox/`。
   - 根据实现结果补 `docs/archive/v1/design-docs/lab-runtime-architecture.md` 中 Lab 与 Kairos 的通信说明。
