...
- 相关文档：
  ...
  - `docs/design-docs/v1-legacy/lab-runtime-architecture.md`
  - `docs/design-docs/v1-legacy/lab-product-design.md`
...
5. 文档与收尾
   - 更新 `docs/design-docs/v1-legacy/agent-kairos-autonomous-mode.md`。
   - 更新 `docs/design-docs/core-storage-and-observability.md` 的 Kairos 目录树与存储边界，加入 `<userData>/kairos/inbox/`。
   - 根据实现结果补 `docs/design-docs/v1-legacy/lab-runtime-architecture.md` 中 Lab 与 Kairos 的通信说明。
