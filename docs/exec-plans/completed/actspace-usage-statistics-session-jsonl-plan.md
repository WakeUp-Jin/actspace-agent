...
- `docs/archive/v1/design-docs/front-usage-statistics.md`：统计页视觉与结构规范。
- `docs/archive/v1/design-docs/usage-statistics-prototype.html`：当前高保真单文件原型。
...
- `docs/archive/v1/design-docs/front-usage-statistics.md`
- `docs/archive/v1/design-docs/usage-statistics-prototype.html`
