...
- 必读文档：
  - `docs/archive/v1/design-docs/agent-kairos-prompt-cache-optimization.md`（本计划的设计事实来源）
...
16. 文档同步：更新 `docs/archive/v1/design-docs/agent-kairos-autonomous-mode.md` 的 prompt 结构描述；按 `docs/HISTORY_GUIDE.md` 写 history；本 plan 移入 `docs/exec-plans/completed/`。
