...
- 已知约束：
  ...
  - Usage Statistics 页面需要贴近 `docs/design-docs/frontend/usage-statistics-prototype.html` 的原型效果。
...
- 手工检查：
  ...
  - 对照 `http://127.0.0.1:5500/docs/design-docs/frontend/usage-statistics-prototype.html` 的原型布局。
