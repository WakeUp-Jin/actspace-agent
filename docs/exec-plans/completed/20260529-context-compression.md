...
设计事实来源：`docs/archive/v1/design-docs/model-context-context-compression.md`。本计划只回答「谁改哪些文件、按什么顺序、每步如何验证、失败如何回退」。
...
- 相关文档：
  - `docs/archive/v1/design-docs/model-context-context-compression.md`（设计事实来源）
