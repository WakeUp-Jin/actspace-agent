...
- 必读文档（新会话 / 子 Agent 先读）：
  ...
  - `docs/archive/v1/design-docs/front-设置页规范.md`（外观章节）
...
- history：`docs/histories/2026-05/20260529-2340-appearance-dark-theme.md`；规范同步：`docs/archive/v1/design-docs/front-设置页规范.md` 外观章节。
