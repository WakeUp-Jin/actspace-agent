...
| 5 | `actspace-bash-session-allowlist-plan.md` | 未执行，已丢弃 | 会话级动态 allowlist + Allow 子命令拆分授权（A+B）。历史设计见 `docs/design-docs/v1-legacy/execution-safety-agent-bash-policy-allowlist-design.md`。 |
...
- `docs/design-docs/v1-legacy/execution-safety-agent-bash-policy-allowlist-design.md`：历史 Bash 全局策略 + 动态 allowlist 设计，含 Phase 1/2/3 路线图。
