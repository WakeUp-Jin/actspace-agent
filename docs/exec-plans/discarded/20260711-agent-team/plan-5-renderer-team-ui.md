...
> 历史子计划：未执行，随 Team V1 父计划于 2026-08-26 丢弃。
...
- `apps/desktop/src/renderer/team/TeamSetupDialog.tsx`（新增）
- `apps/desktop/src/renderer/team/TeamTabBar.tsx`（新增）
- `apps/desktop/src/renderer/team/TeamTaskView.tsx`（新增）
- `apps/desktop/src/renderer/team/TeamMemberView.tsx`（新增）
- `apps/desktop/src/renderer/team/TeamMemberHeader.tsx`（新增）
- `apps/desktop/src/renderer/team/useTeamRuntime.ts`（新增）
- `apps/desktop/src/renderer/team/team-selectors.ts`（新增）
- `apps/desktop/src/renderer/team/test/*.test.tsx`（新增）
- `apps/desktop/src/renderer/components/settings/MemberPresetSettings.tsx`（新增）
- `apps/desktop/src/renderer/components/settings/TeamTemplateSettings.tsx`（新增）
...
pnpm build
rg -n "text-black|bg-black|bg-white|text-\[#|bg-\[#|border-\[#|rgba\(" apps/desktop/src/renderer/team apps/desktop/src/renderer/components/settings
```
