...
- `apps/desktop/src/main/agent-run.ts`
- `apps/desktop/src/main/agent-runtime-context.ts`
...
- `apps/desktop/src/main/team/team-runtime-registry.ts`（新增）
- `apps/desktop/src/main/team/team-ipc.ts`（新增）
- `apps/desktop/src/main/team/team-preset-service.ts`（新增或薄包装）
- `apps/desktop/src/main/team/test/*.test.ts`（新增）
- `apps/desktop/src/main/agent-run.ts`
- `apps/desktop/src/main/agent-runtime-context.ts`
- `apps/desktop/src/main/index.ts`
