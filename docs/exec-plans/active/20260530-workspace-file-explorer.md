...
派生自设计规范 `docs/design-docs/frontend-ui/工作区文件浏览器规范.md`。规范是「为什么 / 做成什么样 / V1-V3 边界 / 安全约束」的事实来源；本计划只负责「谁改哪些文件、按什么顺序、怎么验证」。两者冲突以规范为准。
...
- `docs/design-docs/frontend-ui/工作区文件浏览器规范.md`
