...
This skill exposes diagnostics for the `abb` CLI built from `browser-bridge/apps/cli`.
...
- This skill is an operational wrapper. Long-term design and readiness notes live in `browser-bridge/docs/`.
