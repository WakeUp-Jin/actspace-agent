...
function Preview() {
  ...
  const messages: MessageBlock[] = [
    ...
    { kind: "bash", id: "bash", createdAt, command: "pwd", title: "Run pwd", status: "failed", stdout: "Fixture failure output" },
  ...
  return <TooltipProvider><RightPanelProvider>
    <div className="flex h-screen flex-col bg-app-bg text-text-main">
      <div className="flex shrink-0 items-center gap-4 border-b border-line p-3">
        <span>开发验收样例</span>
