...
function ModelMultiSelector({ models, onChange, onReasoning }: { models: InstalledModelView[]; onChange: (keys: ModelKey[]) => void | Promise<void>; onReasoning?: (model: InstalledModelView) => void }) {
