...
description: "文件写入和编辑中的 TOCTOU 防护、原子写入与内容匹配。"
...
![TOCTOU防护](../../assets/blog/source/write-and-edit/01.png)
...
![文件原子写入](../../assets/blog/source/write-and-edit/02.png)
...
![引号规划化检查](../../assets/blog/source/write-and-edit/03.png)
