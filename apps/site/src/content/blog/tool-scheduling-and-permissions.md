---
title: "工具调度与权限模块的开发"
description: "记录工具调度、权限检查与 allowList 机制的早期设计。"
...
![工具调度流程的设计](../../assets/blog/source/tool-scheduling-and-permissions/01.png)
...
![工具权限验证方法的设计](../../assets/blog/source/tool-scheduling-and-permissions/02.png)
...
那么完整的权限验证系统：
![完整的权限验证系统](../../assets/blog/source/tool-scheduling-and-permissions/03.png)
...
![工具执行状态的显示](../../assets/blog/source/tool-scheduling-and-permissions/04.png)

![工具执行状态的显示](../../assets/blog/source/tool-scheduling-and-permissions/05.png)

![工具执行状态的显示](../../assets/blog/source/tool-scheduling-and-permissions/06.png)