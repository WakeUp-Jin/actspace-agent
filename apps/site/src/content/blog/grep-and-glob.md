...
description: "Glob、Grep 与 ripgrep 的实现取舍、降级策略和检索流程。"
...
![Glob 工具实现](../../assets/blog/source/grep-and-glob/01.png)
...
![Grep 工具实现](../../assets/blog/source/grep-and-glob/02.png)
...
![Ripgrep 自动下载机制](../../assets/blog/source/grep-and-glob/03.png)
