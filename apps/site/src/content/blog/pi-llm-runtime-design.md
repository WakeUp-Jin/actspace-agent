...
description: "PI这个项目中，对于LLM模块的设计，尤其是多供应商的设计是比较出色的，还有它的模型配置文件的字段设计和对于上下文的理解都很不错，在设计层面是考虑到上下文的重要性的。"
...
tags:
  ...
  - Architecture
draft: false
cover: /images/blog/pi-llm-runtime.svg
---
...
![LLM模块的总设计](../../assets/blog/source/pi-llm/1.PNG)
...
![LLM模块内部通用定义](../../assets/blog/source/pi-llm/2.PNG)
...
![消息的数据流动](../../assets/blog/source/pi-llm/3.png)
...
![具体的LLM协议类的实现](../../assets/blog/source/pi-llm/4.png)
...
![Agent执行事件流](../../assets/blog/source/pi-llm/事件流.png)
...
![Agent执行链路](../../assets/blog/source/pi-llm/6.png)
